...
seletorProdutos.addEventListener('change', (event) => {
    ...
    const dadosProduto = listaProdutos.find(produto => produto.id === parseInt(PRODUTO_SELECIONADO));

    // Renderizar titulo "Produto:" e nome do produto na tela.
    // Puxa a lista dos elementos da classe "etiquetaToggleProduto"
    const etiquetaToggleProduto = document.querySelectorAll('.etiquetaToggleProduto');
